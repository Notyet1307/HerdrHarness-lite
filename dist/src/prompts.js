export function renderAttemptPrompt(attempt) {
...
function workerPrompt(attempt, context) {
    return [
...
function reviewerPrompt(attempt, context) {
    return [
...
function envelopeIdentity(attempt, context) {
    return [
...
function handoffInstruction(handoff) {
    if (!handoff)
        return "No typed handoff is attached.";
...
function trustedContextInstruction(context) {
    return [
...
function resultInstruction(attempt, context) {
...
function requireEnvelope(attempt) {
